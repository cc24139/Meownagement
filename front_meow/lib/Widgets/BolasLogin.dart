...
class BolasLogin extends CustomClipper<Path> {
  @override
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(
      ...
      size.width * 0.8,  // Ponto final X (o "vale" da intersecção)
      size.height * 0.25, // Ponto final Y
    );
    ...
    path.quadraticBezierTo(
      size.width * 0.9, // Ponto de controle X
      size.height * 0.70, // Ponto de controle Y (puxa a curva para cima)
      size.width,        // Ponto final X
      size.height * 0.5, // Ponto final Y
    );
